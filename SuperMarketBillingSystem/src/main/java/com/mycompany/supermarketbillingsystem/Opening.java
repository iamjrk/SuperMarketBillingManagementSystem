...
public class Opening extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(3, 58, 58));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("Copperplate Gothic Bold", 0, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Welcome To Product Management System");

        jLabel2.setIcon(new javax.swing.ImageIcon("E:\\2.AccioJob\\Major Project-1\\recreate\\main.png")); // NOI18N
        ...
        Percentage.setFont(new java.awt.Font("Copperplate Gothic Bold", 0, 36)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(Percentage, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[]) {
        ...
        Opening myopening = new Opening();
        myopening.setVisible(true);
        for(int i=0;i<=100;i++)
        {
            try {
                Thread.sleep(35);
                myopening.Myprogress.setValue(i); 
                myopening.Percentage.setText(Integer.toString(i) + "%");
